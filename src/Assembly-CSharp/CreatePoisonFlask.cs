...
{
	public CreatePoisonFlask()
		: base(INTERACTION_TYPE.CREATE_POISON_FLASK)
	{
	...
	protected override void ConstructBasePreconditionsAndEffects()
	{
		...
		AddExpectedEffect(InteractionManager.Instance.GetGoapEffectData(GOAP_EFFECT_CONDITION.HAS_POI, "Poison Flask", p_isKeyANumber: false, GOAP_EFFECT_TARGET.ACTOR));
	}

...
public class TrainHealingMagic : GoapAction
{
	public TrainHealingMagic()
		: base(INTERACTION_TYPE.TRAIN_HEALING_MAGIC)
	{
	...
	public override void Perform(ActualGoapNode goapNode)
	{
		...
		SetState("Train Healing Magic Success", goapNode);
	}
	...
	protected override bool AreRequirementsSatisfied(Character actor, IPointOfInterest poiTarget, OtherData[] otherData, JobQueueItem job)
	{
		if (base.AreRequirementsSatisfied(actor, poiTarget, otherData, job))
		{
			...
			{
				return actor.TryGetTalentLevel(CHARACTER_TALENT.Healing_Magic) < 5;
			}
			return false;
		}
		return false;
	...
	public void PerTickTrainHealingMagicSuccess(ActualGoapNode goapNode)
	{
		GameManager.Instance.CreateParticleEffectAt(goapNode.poiTarget, PARTICLE_EFFECT.Heal, allowRotation: false);
		goapNode.actor.talentComponent.GetTalent(CHARACTER_TALENT.Healing_Magic).AdjustExperience(GameUtilities.RandomBetweenTwoNumbers(1, 2), goapNode.actor);
	}

	public void AfterTrainHealingMagicSuccess(ActualGoapNode goapNode)
	{

...
public class SniffClothes : GoapAction
{
	public override ACTION_CATEGORY actionCategory => ACTION_CATEGORY.INDIRECT;

	public SniffClothes()
		: base(INTERACTION_TYPE.SNIFF_CLOTHES)
	{
	...
	public override void Perform(ActualGoapNode goapNode)
	{
		...
		SetState("Sniff Success", goapNode);
	}
	...
	public void PerTickSniffSuccess(ActualGoapNode goapNode)
	{
		goapNode.actor.needsComponent.AdjustHappiness(2f);
	}

	public void AfterSniffSuccess(ActualGoapNode goapNode)
	{

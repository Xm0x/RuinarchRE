public class FoodComaChoice : InfuseChoice
{
	public FoodComaChoice()
	{
		base.name = "Food Coma";
	...
	{
		p_foodPile.SetInfusedType(FOOD_INFUSE_TYPE.Food_Coma);
	}
	...
	public override bool IsValid()
	{
		...
		if (!manifestFoodData.HasAddedEffectForCurrentLevel(POWER_ADDED_EFFECT.Unlock_Bloated_FoodComa))
		{

...
public class CureCharacter : GoapAction
{
	...
	public CureCharacter()
		: base(INTERACTION_TYPE.CURE_CHARACTER)
	{
	...
	protected override void ConstructBasePreconditionsAndEffects()
	{
		...
		AddExpectedEffect(InteractionManager.Instance.GetGoapEffectData(GOAP_EFFECT_CONDITION.REMOVE_TRAIT, "Plagued", p_isKeyANumber: false, GOAP_EFFECT_TARGET.TARGET));
	}
	...
	public override void PopulateEmotionReactionsToActor(List<EMOTION> reactions, Character actor, IPointOfInterest target, Character witness, ActualGoapNode node, REACTION_STATUS status)
	{
		...
		if (node.GetConvertedUniqueActionData<CureCharacterUAD>().usedPoisonedHealingPotion)
		{
	...
	public override REACTABLE_EFFECT GetReactableEffect(ActualGoapNode node, Character witness)
	{
		...
		{
			CureCharacterUAD convertedUniqueActionData = node.GetConvertedUniqueActionData<CureCharacterUAD>();
	...
	public void PreCureSuccess(ActualGoapNode goapNode)
	{
		...
		{
			goapNode.GetConvertedUniqueActionData<CureCharacterUAD>().SetUsedPoisonedHealingPotion(state: true);
	...
	{
		CureCharacterUAD convertedUniqueActionData = goapNode.GetConvertedUniqueActionData<CureCharacterUAD>();

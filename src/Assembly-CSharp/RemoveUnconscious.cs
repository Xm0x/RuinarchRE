...
public class RemoveUnconscious : GoapAction
{
	...
	public RemoveUnconscious()
		: base(INTERACTION_TYPE.REMOVE_UNCONSCIOUS)
	{
	...
	{
		AddExpectedEffect(InteractionManager.Instance.GetGoapEffectData(GOAP_EFFECT_CONDITION.REMOVE_TRAIT, "Unconscious", p_isKeyANumber: false, GOAP_EFFECT_TARGET.TARGET));
	}
	...
	public override GoapActionInvalidity IsInvalid(ActualGoapNode node)
	{
		...
		if (!goapActionInvalidity.isInvalid && poiTarget.IsPOICurrentlyTargetedByAPerformingAction(JOB_TYPE.REMOVE_STATUS, InteractionManager.Instance.GetGoapEffectData(GOAP_EFFECT_CONDITION.REMOVE_TRAIT, "Unconscious", p_isKeyANumber: false, GOAP_EFFECT_TARGET.TARGET)))
		{

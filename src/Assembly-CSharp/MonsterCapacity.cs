...
{
	[SerializeField]
	private SUMMON_TYPE m_summonType;

	[SerializeField]
	private RACE m_monsterRace;

	[SerializeField]
	private string m_strMonsterClass;

	[SerializeField]
	private readonly string m_strSummonType;
	...
	public MonsterCapacity(SUMMON_TYPE p_summonType, RACE p_monsterRace, string p_monsterClass)
	{
		...
		m_strSummonType = p_summonType.ToStringEnumWithSpace();

...
public class SpreadPlagueToVillagers : GoalTask
{
	public int neededSpreadPlagueCount { get; private set; }

	public int currentSpreadPlagueCount { get; private set; }

	public override Type serializedData => typeof(SaveDataSpreadPlague);

	public SpreadPlagueToVillagers()
	{
	...
	public SpreadPlagueToVillagers(SaveDataSpreadPlague p_data)
		: base(p_data)
	{
	...
	{
		Log log = GameManager.CreateNewLogUsingNewLocalization(GameManager.Instance.Today(), "Goals", "Goals_Table", "Spread_Plague_Task");
	...
	{
		if (p_trait is Plagued && p_character.isNormalCharacter && p_character.race.IsSapient())
		{

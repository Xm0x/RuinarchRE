...
public class ScrollingCalendar : MonoBehaviour
{
	...
	private void InitializeYears()
	{
		...
		for (int i = 0; i < array.Length; i++)
		{
			...
			gameObject.GetComponentInChildren<Text>().text = $"{array[i]}";

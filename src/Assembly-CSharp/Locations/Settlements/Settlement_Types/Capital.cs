...
{
	public Capital()
		: base(SETTLEMENT_TYPE.Capital)
	{
		base.maxDwellings = 24;
		base.maxFacilities = 12;
	}

	public Capital(SaveDataSettlementType data)
		: base(data)
	{
		base.maxDwellings = 24;
		base.maxFacilities = 12;
	...
	public override void ApplyDefaultSettings()
	{
		...
		SetInitialFacilityWeightAndCap(new StructureSetting(STRUCTURE_TYPE.HUNTER_LODGE, RESOURCE.STONE), 80, 2);

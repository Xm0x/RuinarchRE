...
{
	public HumanVillage()
		: base(SETTLEMENT_TYPE.Human_Village)
	{
		base.maxDwellings = 16;
		base.maxFacilities = 16;
	}

	public HumanVillage(SaveDataSettlementType saveData)
		: base(saveData)
	{
		base.maxDwellings = 16;
		base.maxFacilities = 16;
	...
	public override void ApplyDefaultSettings()
	{
		...
		SetInitialFacilityWeightAndCap(new StructureSetting(STRUCTURE_TYPE.FISHERY, RESOURCE.NONE), 30, 1);

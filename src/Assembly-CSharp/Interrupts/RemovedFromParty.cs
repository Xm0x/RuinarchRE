...
public class RemovedFromParty : Interrupt
{
	public RemovedFromParty()
		: base(INTERRUPT.Removed_From_Party)
	{
		base.duration = 0;
	...
	public override bool ExecuteInterruptStartEffect(InterruptHolder interruptHolder, ref Log overrideEffectLog, ActualGoapNode goapNode = null)
	{
		...
		if (currentParty != null)
		{
			...
			currentParty.banningComponent.BanCharacter(interruptHolder.actor);
		}
		return true;
	}
}

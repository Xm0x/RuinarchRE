...
public class TaskManager : MonoBehaviour
{
	...
	public WeightedDictionary<PILLAGE_ACTION> pillageActions => _pillageActions;

	public WeightedDictionary<HUNT_ACTION> huntActions => _huntActions;

	public WeightedDictionary<string> vampiricEmbraceActions => _vampiricEmbraceActions;

	public WeightedDictionary<string> drinkBloodActions => _drinkBloodActions;

	public WeightedDictionary<string> hypnotizeActions => _hypnotizeActions;

	public WeightedDictionary<string> stealActions => _stealActions;

	public WeightedDictionary<string> stealAttemptActions => _stealAttemptActions;

...
{
	public Action<bool> onToggleDarkBlessing;

	public Action<bool> onToggleEmpower;

	public Action<bool> onToggleCleanseFlaws;

	public Action onHoverDarkBlessing;

	public Action onHoverEmpower;

	public Action onHoverCleanseFlaws;

	public Action onHoverOutTemptation;

...
public class ClericBehaviour : CharacterBehaviour
{
	public ClericBehaviour()
	{
		base.priority = 18;
	}
	...
	{
		if (character.homeSettlement == null && !WorldSettings.Instance.worldSettingsData.villageSettings.disableNewVillages && !character.currentRegion.IsRegionVillageCapacityReached() && character.faction != null && character.faction.factionType.type == FACTION_TYPE.Divine_Church && character.characterClass.className == "Priest")
		{
	...
	{
		if (ChanceData.RollChance(CHANCE_TYPE.Cultist_Preach) && character.jobComponent.TryGetValidEvangelizeTarget(out var targetCharacter, RELIGION.Divine_Worship))
		{

...
{
	[SerializeField]
	private SpriteSpriteDictionary _oreVeinSprite;
	...
	public void EvaluateImpassables(OreVein oreVein)
	{
		...
		if (locationGridTile != null)
		{
			...
			oreVein.SetImpassables(leftBotImpassable.activeSelf, leftTopImpassable.activeSelf, topLeftImpassable.activeSelf, topRightImpassable.activeSelf, rightTopImpassable.activeSelf, rightBotImpassable.activeSelf, botRightImpassable.activeSelf, botLeftImpassable.activeSelf);
			ApplyGraphUpdate();
		}
	}

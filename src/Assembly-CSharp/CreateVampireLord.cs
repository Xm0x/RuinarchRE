...
public class CreateVampireLord : GoalTask
{
	public override Type serializedData => typeof(SaveDataCreateVampireLord);

	public CreateVampireLord()
	{
		base.taskName = LocalizationManager.Instance.GetLocalizedValue("Goals_Table", "Create_Vampire_Lord_Task");
		base.taskTooltip = LocalizationManager.Instance.GetLocalizedValue("Goals_Table", "Create_Vampire_Lord_Task_Tooltip");
	}

	public CreateVampireLord(SaveDataCreateVampireLord p_data)
		: base(p_data)
	{
	}
	...
	{
		if (p_newClass.className == "Vampire Lord")
		{
			CompleteTask();
		}
	}

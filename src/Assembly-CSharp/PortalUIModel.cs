...
public class PortalUIModel : MVCUIModel
{
	...
	public Action onReleaseAbilityClicked;

	public Action onUpgradePortalClicked;

	public Action onCancelReleaseAbilityClicked;

	public Action onCancelUpgradePortalClicked;
	...
	public Action onHoverOverUpgradePortal;

	public Action onHoverOutUpgradePortal;

	public Action onClickClose;

	private void Awake()
	{
		btnReleaseAbility.SetButtonLabelName(LocalizationManager.Instance.GetLocalizedValue("UIStrings_Table", "player_release_ability"));
		btnUpgradePortal.SetButtonLabelName(LocalizationManager.Instance.GetLocalizedValue("UIStrings_Table", "player_upgrade_portal"));
	}

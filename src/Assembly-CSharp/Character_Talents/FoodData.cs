...
public class FoodData : CharacterTalentData
{
	...
	{
		p_character.classComponent.AddAbleClass("Farmer");
	}

	private void Level2(Character p_character)
	{
		p_character.classComponent.AddAbleClass("Fisher");
	}
	...
	{
		p_character.classComponent.AddAbleClass("Butcher");
	}

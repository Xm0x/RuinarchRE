...
public class WindBlastData : SkillData
{
	...
	public override int radius => PlayerSkillManager.Instance.GetTileRangeBonusPerLevel(PLAYER_SKILL_TYPE.WIND_BLAST);

	public WindBlastData()
	{
		base.targetTypes = new SPELL_TARGET[1] { SPELL_TARGET.TILE };
		_traitableCallback = ApplyWindDamage;
	}
	...
	public override void ActivateAbility(LocationGridTile targetTile)
	{
		...
		GameObject gameObject = GameManager.Instance.CreateParticleEffectAt(targetTile, PARTICLE_EFFECT.Wind_Blast);
		AkSoundEngine.PostEvent("Play_Wind_Blast", gameObject);
		...
		{
			remnantTrait.SetSpellUsed(PLAYER_SKILL_TYPE.WIND_BLAST);
		}
	...
	{
		traitable.AdjustHP(-processedDamage, ELEMENTAL_TYPE.Wind, triggerDeath: true, this, null, showHPBar: true, piercing, isPlayerSource: true);

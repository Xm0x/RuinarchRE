...
public class CanTakeExtraChangeClass : CanTakeJobChecker
{
	public override string key => "CanTakeExtraChangeClass";

	public override bool CanTakeJob(Character character, JobQueueItem jobQueueItem)
	{
		if (character.isNormalCharacter && character.race != RACE.RATMAN && character.classComponent.canChangeClass && character.structureComponent.workPlaceStructure == null && jobQueueItem is GoapPlanJob goapPlanJob)
		{

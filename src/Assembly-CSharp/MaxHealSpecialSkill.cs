...
{
	public MaxHealSpecialSkill()
		: base(COMBAT_SPECIAL_SKILL.Max_Heal, COMBAT_SPECIAL_SKILL_TARGET.Single, COMBAT_SPECIAL_SKILL_CATEGORY.Healing, 20, 3)
	{
	}
	...
	public override bool TryActivateSkill(Character p_character)
	{
		...
		{
			validTargetFor.AdjustHP(200, ELEMENTAL_TYPE.Normal);

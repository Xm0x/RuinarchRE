public class TriggerFlawChaosOrb : PassiveSkill
{
	...
	private void OnTriggerFlawSuccess(Character p_character)
	{
		if (PlayerSkillManager.Instance.GetSkillData(PLAYER_SKILL_TYPE.TRIGGER_FLAW).TryDecreaseRemainingChaosOrbs(1))
		{

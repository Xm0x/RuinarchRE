...
public abstract class MVCUIController : MonoBehaviour
{
	...
	public void InitUI(MVCUIModel p_newModel, MVCUIView p_newView)
	{
		...
		{
			m_mvcUIView.transform.SetParent(UIManager.Instance.transform);
		}
		else
		{
			m_mvcUIView.transform.SetParent(UnityEngine.Object.FindObjectOfType<Camera>().transform);
		}
	...
	{
		m_mvcUIModel.parentDisplay.transform.parent.SetParent(p_newParent, worldPositionStays: false);
	}
}

...
public class SnareTrapped : Status
{
	public List<Character> awareCharacters { get; private set; }

	public GameDate dateAdded { get; private set; }

	public override Type serializedData => typeof(SaveDataSnareTrapped);

	public SnareTrapped()
	{
		name = "Snare Trapped";
		description = "This object has a hidden snare trap.";
	...
	public override void LoadFirstWaveInstancedTrait(SaveDataTrait saveDataTrait)
	{
		...
		SaveDataSnareTrapped saveDataSnareTrapped = saveDataTrait as SaveDataSnareTrapped;
		dateAdded = saveDataSnareTrapped.dateAdded;
	}

	public override void LoadSecondWaveInstancedTrait(SaveDataTrait p_saveDataTrait)
	{
		base.LoadSecondWaveInstancedTrait(p_saveDataTrait);
		SaveDataSnareTrapped saveDataSnareTrapped = p_saveDataTrait as SaveDataSnareTrapped;
		awareCharacters.AddRange(SaveUtilities.ConvertIDListToCharacters(saveDataSnareTrapped.awareCharacterIDs));
	}
	...
	public override void VillagerReactionToTileObjectTrait(TileObject owner, Character actor, ref string debugLog)
	{
		...
		if (!actor.combatComponent.isInActualCombat && !owner.HasJobTargetingThis(JOB_TYPE.REMOVE_TRAP))
		{
			...
			{
				actor.jobComponent.TriggerRemovePlayerTrap(actor, owner, "Snare Trapped");
			}

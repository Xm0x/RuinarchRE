...
public class FreezingTrapped : Status
{
	public List<Character> awareCharacters { get; private set; }

	public GameDate dateAdded { get; private set; }

	public override Type serializedData => typeof(SaveDataFreezingTrapped);

	public FreezingTrapped()
	{
		name = "Freezing Trapped";
		description = "This object has a hidden freezing trap.";
	...
	public override void LoadFirstWaveInstancedTrait(SaveDataTrait saveDataTrait)
	{
		...
		SaveDataFreezingTrapped saveDataFreezingTrapped = saveDataTrait as SaveDataFreezingTrapped;
		dateAdded = saveDataFreezingTrapped.dateAdded;
	}

	public override void LoadSecondWaveInstancedTrait(SaveDataTrait p_saveDataTrait)
	{
		base.LoadSecondWaveInstancedTrait(p_saveDataTrait);
		SaveDataFreezingTrapped saveDataFreezingTrapped = p_saveDataTrait as SaveDataFreezingTrapped;
		awareCharacters.AddRange(SaveUtilities.ConvertIDListToCharacters(saveDataFreezingTrapped.awareCharacterIDs));
	}
	...
	public override void VillagerReactionToTileObjectTrait(TileObject owner, Character actor, ref string debugLog)
	{
		...
		if (!actor.combatComponent.isInActualCombat && !owner.HasJobTargetingThis(JOB_TYPE.REMOVE_TRAP))
		{
			...
			{
				actor.jobComponent.TriggerRemovePlayerTrap(actor, owner, "Freezing Trapped");
			}
